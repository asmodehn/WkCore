...
- auto source dependency ( in ext/ subdirectory , automatically added as static library target )
- auto binary dependency ( in another Wk build directory, automatically imported )
